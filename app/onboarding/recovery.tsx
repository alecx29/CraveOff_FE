        ...
        >
          <View style={styles.contentContainer}>
            <View style={styles.imageContainer}>
              <LottieUniversal
                source={require('@/assets/images/Animation - Recovery.json')}
                autoPlay
                loop
                style={styles.lottie}
              />
            </View>
            <Text style={[styles.title, { color: '#ffffff' }]}>Path to Recovery</Text>
            <Text style={[styles.subtitle, { color: '#ffffff' }]}>Recovery is possible. By abstaining from porn, your brain can rest its dopamine sensitivity, leading to healthier relationship and improved well-being.</Text>
          </View>
        </ScrollView>
