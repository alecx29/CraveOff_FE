...
export default function UnhappyOnboarding() {
        ...
        >
          <View style={styles.contentContainer}>
            <View style={styles.imageContainer}>
              <LottieUniversal
                source={require('@/assets/images/Animation - sad.json')}
                autoPlay
                loop
                style={styles.lottie}
              />
            </View>
            <Text style={[styles.title, { color: '#ffffff' }]}>Feeling unhappy?</Text>
            <Text style={[styles.subtitle, { color: '#ffffff' }]}>An elevated dopamine level means you need more dopamine to feel good. This is why so many heavy porn users report feeling depressed, unmotivated , and anti-social</Text>
          </View>
        </ScrollView>
