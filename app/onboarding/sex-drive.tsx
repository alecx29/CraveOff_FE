        ...
        >
          <View style={styles.contentContainer}>
            <View style={styles.imageContainer}>
              <LottieUniversal
                source={require('@/assets/images/Animation - sexDrive.json')}
                autoPlay
                loop
                style={styles.lottie}
              />
            </View>
            <Text style={[styles.title, { color: '#ffffff' }]}>Porn shatters sex drive</Text>
            <Text style={[styles.subtitle, { color: '#ffffff' }]}>More than 50% of porn addicts have reported a decrease in libido, loss of interest in real sex, and an overall decrease in their sex drive</Text>
          </View>
        </ScrollView>
