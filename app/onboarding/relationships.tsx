...
export default function RelationshipsOnboarding() {
  const { theme } = useTheme();
  
  // Handler to navigate to next page
  const handleNext = () => {
    router.push('/onboarding/sex-drive');
  };
        ...
        >
          <View style={styles.contentContainer}>
            <View style={styles.imageContainer}>
              <LottieUniversal
                source={require('@/assets/images/Animation - brokenHeart.json')}
                autoPlay
                loop
                style={styles.lottie}
              />
            </View>
            <Text style={[styles.title, { color: '#ffffff' }]}>Porn destroys relationships</Text>
            <Text style={[styles.subtitle, { color: '#ffffff' }]}>Porn reduces your hunger for a real relationship - and replaces it with the hunger for more porn.</Text>
          </View>
        </ScrollView>
